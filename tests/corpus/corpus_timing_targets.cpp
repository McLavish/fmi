// Behavioural acceptance corpus — axis: timing-and-targets
//
// This translation unit owns the "timing-and-targets" axis and nothing else.  Append scenarios to the
...
// "timing_and_targets_<short_name>").
//
...
std::vector<Scenario> corpus_timing_targets_scenarios() {
    std::vector<Scenario> batch;
    // Author this axis's scenarios here, one push_back per scenario.
    return batch;
}

FMI_REGISTER_SCENARIOS("timing-and-targets", corpus_timing_targets_scenarios)
